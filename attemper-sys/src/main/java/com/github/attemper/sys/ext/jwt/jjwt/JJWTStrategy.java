...
public class JJWTStrategy implements JWTStrategy {
    ...
    @Override
    public String createToken(long expireMills, Tenant tenant) {
        ...
        return Jwts.builder()
                ...
                .setSubject(tenant.getUserName())  //代表这个JWT的主体，即它的所有人，这个是一个json格式的字符串，可以存放什么userid，roldid之类的，作为什么用户的唯一标志。
    ...
    public Tenant parseToken(String token) throws JWTExpiredException, JWTDecodedException {
        try{
            ...
            return SpringContextAware.getBean(ObjectMapper.class).readValue(jsonStr, Tenant.class);
