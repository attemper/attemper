...
public class ExecutorHandler extends CrossSystemHandler {
    ...
    public void terminate(String baseUrl, JobInstanceIdParam param) {
        call(buildFullPath(baseUrl, APIPath.ExecutorPath.TERMINATE), param);
    }

    public void pause(String baseUrl, JobInstanceIdParam param) {
        call(buildFullPath(baseUrl, APIPath.ExecutorPath.PAUSE), param);
    }

    public void activate(String baseUrl, JobInstanceIdParam param) {
        call(buildFullPath(baseUrl, APIPath.ExecutorPath.ACTIVATE), param);
    }

    private void call(String fullPath, Object param) {
