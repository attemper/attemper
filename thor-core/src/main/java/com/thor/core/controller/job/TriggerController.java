 ...
 * @author ldang
 */
@Api(tags = ThorAPIConst.Tag.TRIGGER)
@RestController
public class TriggerController {
	...
	@ApiOperation(ThorAPIConst.Operation.Job.Trigger.UPDATE)
	@ApiImplicitParam(value = "被更新的数据", name = "saveParam", dataType = "TriggerUpdateParam", required = true)
	@PutMapping(ThorAPIPath.Job.Trigger.UPDATE)
	...
	@ApiOperation(ThorAPIConst.Operation.Job.Trigger.GET)
	@ApiImplicitParam(value = "查询单个对象信息", name = "getParam", dataType = "TriggerGetParam", required = true)
	@GetMapping(ThorAPIPath.Job.Trigger.GET)
