  ...
  <el-row :gutter="10">
    ...
    <el-col v-show="project.projectName" :span="14">
      <el-card>
        ...
        <div v-if="visible">
          <el-form ref="form" :model="project" :rules="formRules" label-width="130px" label-position="right">
            <el-form-item :label="$t('job.project.label.projectName')" prop="projectName">
              <el-input v-model="project.projectName" :placeholder="$t('job.project.placeholder.projectName')" />
            </el-form-item>
            <el-form-item :label="$t('job.project.label.displayName')" prop="displayName">
              <el-input v-model="project.displayName" :placeholder="$t('job.project.placeholder.displayName')" />
            </el-form-item>
            <el-form-item :label="$t('job.project.label.contextPath')">
              <el-input v-model="project.contextPath" :placeholder="$t('job.project.placeholder.contextPath')" />
            </el-form-item>
            <el-form-item :label="$t('job.project.label.position')">
      ...
      <el-card style="margin-top: 10px;">
        <div slot="header">
          <span>{{ $t('job.project.title.rightBottom') }}</span>
        </div>
        <div>
          <el-table
            :data="projectInfos"
...
export default {
  ...
  methods: {
    setFormRules() {
      this.formRules.projectName[0].message = this.$t('job.project.rules.projectName')
      this.formRules.displayName[0].message = this.$t('job.project.rules.displayName')
    },
    initTreeData() {
